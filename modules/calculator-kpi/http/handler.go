...
import (
	...
	"byu-crm-service/modules/calculator-kpi/service"
	"byu-crm-service/modules/calculator-kpi/validation"
...
type KpiYaeRangeHandler struct {
	service             service.CalculatorKpiService
}

func NewKpiYaeRangeHandler(service service.CalculatorKpiService) *KpiYaeRangeHandler {
	return &KpiYaeRangeHandler{service: service}
}

func (h *KpiYaeRangeHandler) GetCurrentParameters(c *fiber.Ctx) error {
...
func (h *KpiYaeRangeHandler) CreateParameters(c *fiber.Ctx) error {
