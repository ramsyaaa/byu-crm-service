...
func (s *areaService) GetAllAreas(filters map[string]string, userRole string, territoryID int, withGeo bool) ([]response.AreaResponse, int64, error) {
	return s.repo.GetAllAreas(filters, userRole, territoryID, withGeo)
}
