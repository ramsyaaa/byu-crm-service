...
type AbsenceUserService interface {
	GetAllAbsences(limit int, paginate bool, page int, filters map[string]string, user_id int, month int, year int) ([]models.AbsenceUser, int64, error)
	...
	AlreadyAbsenceInSameDay(user_id int, type_checking string) (*models.AbsenceUser, error)
