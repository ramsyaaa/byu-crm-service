...
import (
	...
	"byu-crm-service/modules/program/repository"
...
func NewProgramService(
	...
	branchRepo branchRepo.BranchRepository,
	clusterRepo clusterRepo.ClusterRepository,
	cityRepo cityRepo.CityRepository) ProgramService {
...
func (s *programService) GetAllPrograms(limit int, paginate bool, page int, filters map[string]string, userRole string, territoryID int, userID int, accountID int) ([]response.ProgramResponse, int64, error) {
	...
	return s.repo.GetAllPrograms(limit, paginate, page, filters, subjectIDs)
}
