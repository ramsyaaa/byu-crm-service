...
func (r *programRepository) GetAllPrograms(limit int, paginate bool, page int, filters map[string]string, subjectIDs []int) ([]response.ProgramResponse, int64, error) {
	var products []response.ProgramResponse
	var total int64
